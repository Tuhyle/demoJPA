...
<body>
	<div class="container">
		...
		<!-- modelAttribute se lay tu modelAttributeName trong Controller voi phuong thuc findByStudentId() -->
			<form:form action="/saveStudent" cssClass="form-horizontal" method="post" modelAttribute="student">
				<label for="id" class="col-md-3 control-label">ID: <c:out value="${student.id}" /></label>
