...
@EnableJpaRepositories(basePackages = { "com.example.demoJpa.repositories" }) //trỏ tới root package
...
public class JpaConf {
	...
	protected LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan("com.example.demoJpa");
